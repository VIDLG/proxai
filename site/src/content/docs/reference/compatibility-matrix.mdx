...
This page is the stable lookup table for protocol-pair behavior. Use [Choosing a Protocol](/protocol/choosing-a-protocol) for guidance and [Lossiness and Fidelity](/protocol/lossiness-and-fidelity) for interpretation.
...
- [Responses to Anthropic Messages](/developer/protocol-conversion/openai-responses-to-anthropic-messages)
