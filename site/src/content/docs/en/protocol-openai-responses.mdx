...
For the user-facing terminal-event expectations, see [Streaming Behavior](/en/streaming-behavior). For identifier and event-granularity rules, see [Protocol Conversion](/en/protocol-conversion).
