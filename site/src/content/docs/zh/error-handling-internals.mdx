...
<FeatureGrid
  items={[
    { title: '配置说明', href: '/zh/configuration', icon: 'config', description: '通过 `[error_responses]` 选择 text 或 JSON 错误响应。' },
    { title: '观测与诊断', href: '/zh/observability', icon: 'terminal', description: '安全调试失败请求的 capture 和日志边界。' },
    { title: '常见排障', href: '/zh/troubleshooting', icon: 'alert', description: '面向用户的症状卡片和下一步检查。' },
  ]}
/>
