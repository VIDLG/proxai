...
- `src/ingress/` parses HTTP body bytes and maps application errors/notices; `crates/proxai-core/src/ingress/` owns structured normalization and validation before translation.
