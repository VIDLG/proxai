...
- `crates/proxai-core/src/provider/` owns carrier-independent provider request value preparation, response compatibility normalization, and typed provider adaptation observations.
