...
> This is the developer entry point for `src/translation/`. If you are looking for user-facing protocol behavior, start with [Protocol Guide](/protocol).
...
Do not pass HTTP `Response`, `Body`, provider request structs, or route/model rewrite details into `src/translation/`. This is the carrier-boundary purity required by [Behavior Contract C26](/reference/behavior-contracts#translation-purity).
