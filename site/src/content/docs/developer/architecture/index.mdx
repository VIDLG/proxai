...
- `proxai-core/ingress/` is the structured value boundary for normalization and validation; `src/pipeline/inbound.rs` adapts HTTP bytes and application diagnostics.
