...
- crates/
  - proxai-core/
    - src/
      ...
      - provider/ — carrier-independent provider request preparation and response/error normalization
...
<ModuleGrid
  modules={[
    ...
    { name: 'proxai-core/provider/', icon: 'key', description: 'Carrier-independent provider request value preparation, response compatibility policy, structured response/event and error-payload normalization, and typed adaptation observations.' },
