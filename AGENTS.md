...
- `crates/proxai-core/src/provider/` owns carrier-independent provider request payload preparation, response compatibility policy, structured response/error normalization, and typed provider adaptation observations.
