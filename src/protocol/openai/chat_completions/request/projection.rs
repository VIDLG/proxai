...
impl From<CreateChatCompletionRequest> for RequestProjection {
    fn from(request: CreateChatCompletionRequest) -> Self {
        ...
        Self {
            ...
            max_tokens,
            n: request.n,
            prediction: request.prediction.map(Into::into),
